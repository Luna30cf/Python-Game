import pygame
import pytmx
from erika.joueur import Joueur  # Assurez-vous que la classe Joueur est correctement importée
from erika.camera import Camera  # Assurez-vous que la classe Camera est correctement importée
